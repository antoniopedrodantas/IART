...
class Level:
    ...
    def __init__(self, i):
        ...
        # level 0
        if(i == 0):
            self.player = pygame.Rect(175, 100, 25, 25)
        ...
        #level 1
            ...
            self.player = pygame.Rect(275, 175, 25, 25)
        ...
        if(i == 4):
            ...
            self.floor = [
                [pygame.Rect(200, 75, 25, 275), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(225, 75, 25, 275), 0.0, 0.0, 0.0, 0.0], 
                [pygame.Rect(250, 75, 25, 275), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(275, 75, 25, 275), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(300, 75, 25, 275), 0.0, 0.0, 0.0, 0.0],
            ]
        ...
        if(i == 5):
            ...
            self.floor = [
                ...
                [pygame.Rect(250, 150, 25, 225), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(275, 150, 25, 225), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(300, 150, 25, 225), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(325, 150, 25, 225), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(350, 150, 25, 175), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(375, 150, 25, 175), 0.0, 0.0, 0.0, 0.0],
            ]
        ...
        if(i == 6):
            ...
            self.floor = [
                [pygame.Rect(150, 150, 25, 100), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(175, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(200, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(225, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(250, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(275, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(300, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
                [pygame.Rect(325, 150, 25, 200), 0.0, 0.0, 0.0, 0.0],
            ]
