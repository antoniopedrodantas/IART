    ...
    def __init__(self, i):
        ...
        if(i == 1):
            ...
            self.arena = [
                ...
                pygame.Rect(100, 200, 50, 25), #bottom horizontal
                pygame.Rect(175, 200, 50, 25),

                pygame.Rect(75, 125, 25, 100), #vertical left
                pygame.Rect(100, 75, 25, 75),

                pygame.Rect(100, 75, 125, 25), #up horizontal

                pygame.Rect(200, 75, 25, 150), #vertical right
        ...
        if(i == 3):
            ...
            self.floor = [
                pygame.Rect(150, 100, 25, 175),
                pygame.Rect(125, 100, 25, 175),
                pygame.Rect(100, 100, 25, 175),
            ]

            self.arena = [
                pygame.Rect(100, 75, 25, 25),
                pygame.Rect(150, 75, 25, 25),
                pygame.Rect(75, 75, 25, 200),
                pygame.Rect(75, 275, 125, 25),
